...
struct CONTROLLER
{
	long	softwareVersion = 20211215;  //yyyymmdd captured as an integer
	uint16_t	currentLimit = 1000;
	uint8_t	voltageLimit = 15;
	char SSID[21] = "DCC_ESP32";
	char pwd[21] = "";
...
//jogwheel related
//static int8_t setLocoFromJog(nsJogWheel::JOGWHEEL &j);   //debug
