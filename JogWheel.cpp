...
//2021-12-15 bugfix, INPUT_PULLDOWN_16 is for ESP8266 only
//2021-12-23 added ENTER/EXIT_CRITICAL for the ISR routine
//any code in the main loop which writes to the jogWheel object also needs to put a lock on this
...
2021-12-23 modified code to use portMUX_TYPE mux = portMUX_INITIALIZER_UNLOCKED;
which is required on ISRs for the ESP32
*/
...
#ifdef ESP32
		pinMode(PIN_HEARTBEAT, INPUT_PULLDOWN);
#elif defined(ESP8266)
		//specific to the ESP8266
